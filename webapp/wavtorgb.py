...
def wavelen2rgb(Frequency, MaxIntensity=100):
...
#------------------------ Overall Function Code ------------------------
    ...
    if (Frequency >= 380.0) and (Frequency < 440.0):
        Red   = -(Frequency - 440.) / (440. - 380.)
        Green = 0.0
        Blue  = 1.0

    elif (Frequency >= 440.0) and (Frequency < 490.0):
        Red   = 0.0
        Green = (Frequency - 440.) / (490. - 440.)
        Blue  = 1.0

    elif (Frequency >= 490.0) and (Frequency < 510.0):
        Red   = 0.0
        Green = 1.0
        Blue  = -(Frequency - 510.) / (510. - 490.)

    elif (Frequency >= 510.0) and (Frequency < 580.0):
        Red   = (Frequency - 510.) / (580. - 510.)
        Green = 1.0
        Blue  = 0.0

    elif (Frequency >= 580.0) and (Frequency < 645.0):
        Red   = 1.0
        Green = -(Frequency - 645.) / (645. - 580.)
        Blue  = 0.0

    elif (Frequency >= 645.0) and (Frequency <= 780.0):
        Red   = 1.0
        Green = 0.0
        Blue  = 0.0
    ...
    if (Frequency >= 380.0) and (Frequency < 420.0):
        Factor = 0.3 + 0.7*(Frequency - 380.) / (420. - 380.)
    elif (Frequency >= 420.0) and (Frequency < 701.0):
        Factor = 1.0
    elif (Frequency >= 701.0) and (Frequency <= 780.0):
